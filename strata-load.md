...
- Legacy fingerprints (`.ai/MEMORY-MAP.md`, `docs/PROJECT-MAP.md`, `.claude/memory/`) → **legacy layout**: orient from what exists, tell the user this is a v1/v2 layout, offer the `MIGRATIONS.md` ladder. Never scaffold v3 beside it.
- Neither, but `.strata/memory/project_state.md` exists → **flat mode**: read it as the single source.
