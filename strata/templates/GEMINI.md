...
Project memory is repo-owned under `.ai/`. Do not write project memory to tool-owned paths such as `~/.gemini/`, `~/.claude/`, `~/.codex/`, or other per-tool state directories.
